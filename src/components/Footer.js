    ...
    <Container style={{ fontSize: 14, marginTop: 50 }}>
      <Row>
        <Col className="d-flex flex-column flex-md-row justify-content-sm-between">
          ...
          <ListGroup className="mb-3" as="ul">
            <ListGroup.Item className="border-0 p-0" as="li" style={headSection}>
              Features
            </ListGroup.Item>
            <ListGroup.Item className="border-0 p-0" as="li">
              <ListGroup as="ul" className="d-flex flex-row flex-md-column justify-content-between">
                <ListGroup.Item className="border-0 p-0" as="li">
                  Find Ticket
                </ListGroup.Item>
                <ListGroup.Item className="border-0 p-0" as="li">
          ...
          <ListGroup className="mb-3" as="ul">
            ...
            <ListGroup.Item className="d-flex flex-md-column justify-content-center border-0 p-0" as="li">
          ...
          <ListGroup className="mb-3" as="ul">
            ...
            <ListGroup.Item className="d-flex justify-content-start border-0 p-0" as="li">
              <FiFacebook color="#595959" size={20} style={{ marginRight: 10 }} />
              <FiTwitter color="#595959" size={20} style={{ marginRight: 10 }} />
              <FiInstagram color="#595959" size={20} style={{ marginRight: 10 }} />
              <FiYoutube color="#595959" size={20} style={{ marginRight: 10 }} />
            </ListGroup.Item>
          </ListGroup>
        </Col>
      </Row>
